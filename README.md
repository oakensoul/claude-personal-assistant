...
- **Bug Fixes**: workflow-init now creates agents in correct `.claude/project/context/` directory
...
- **Two-Tier Agent Architecture**: Global agents in `.claude/project/context/` with project-specific context
