...
**Location**: `{project}/${CLAUDE_CONFIG_DIR}/project/context/privacy-security-auditor/`
...
1. **Load Both Contexts**:
   ...
   - Project-level knowledge from `{project}/${CLAUDE_CONFIG_DIR}/project/context/privacy-security-auditor/`
...
1. **Detect Missing Context**:
   - Check for existence of `{cwd}/${CLAUDE_CONFIG_DIR}/project/context/privacy-security-auditor/`
...
1. **Detect Missing Configuration**:
   ...
   - Check if `{cwd}/${CLAUDE_CONFIG_DIR}/project/context/privacy-security-auditor/` does NOT exist
...
```text
Loading project-level privacy knowledge from {cwd}/${CLAUDE_CONFIG_DIR}/project/context/privacy-security-auditor/
...
if [ -d "${CLAUDE_CONFIG_DIR}/project/context/privacy-security-auditor" ]; then
...
- Is `${CLAUDE_CONFIG_DIR}/project/context/privacy-security-auditor/` present?
...
- Project knowledge: `{project}/${CLAUDE_CONFIG_DIR}/project/context/privacy-security-auditor/`
