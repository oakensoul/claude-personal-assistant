...
**Location**: `{project}/${CLAUDE_CONFIG_DIR}/agents-global/shell-script-specialist/`
...
1. **Load Both Contexts**:
   ...
   - Project-level knowledge from `{project}/${CLAUDE_CONFIG_DIR}/agents-global/shell-script-specialist/`
...
1. **Detect Missing Context**:
   - Check for existence of `{cwd}/${CLAUDE_CONFIG_DIR}/agents-global/shell-script-specialist/`
...
2. **Provide Notice**:
   ...
   For project-specific patterns, add documentation to {project}/${CLAUDE_CONFIG_DIR}/agents-global/shell-script-specialist/
   ```
...
1. **Detect Missing Configuration**:
   ...
   - Check if `{cwd}/${CLAUDE_CONFIG_DIR}/agents-global/shell-script-specialist/` does NOT exist
...
**Project-Level Knowledge**: `{project}/${CLAUDE_CONFIG_DIR}/agents-global/shell-script-specialist/`
...
- Project knowledge: `{project}/${CLAUDE_CONFIG_DIR}/agents-global/shell-script-specialist/`
