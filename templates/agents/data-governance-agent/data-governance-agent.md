...
**Location**: `{project}/${CLAUDE_CONFIG_DIR}/agents-global/data-governance-agent/`
...
1. **Load Both Contexts**:
   ...
   - Project-level knowledge from `{project}/${CLAUDE_CONFIG_DIR}/agents-global/data-governance-agent/`
...
1. **Detect Missing Context**:
   - Check for existence of `{cwd}/${CLAUDE_CONFIG_DIR}/agents-global/data-governance-agent/`
...
1. **Detect Missing Configuration**:
   ...
   - Check if `{cwd}/${CLAUDE_CONFIG_DIR}/agents-global/data-governance-agent/` does NOT exist
...
- Is `${CLAUDE_CONFIG_DIR}/agents-global/data-governance-agent/` present?
...
- Project knowledge: `{project}/${CLAUDE_CONFIG_DIR}/agents-global/data-governance-agent/`
