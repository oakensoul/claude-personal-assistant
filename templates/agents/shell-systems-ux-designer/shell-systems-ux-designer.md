...
**Location**: `{project}/${CLAUDE_CONFIG_DIR}/project/context/shell-systems-ux-designer/`
...
1. **Load Both Contexts**:
   ...
   - Project-level knowledge from `{project}/${CLAUDE_CONFIG_DIR}/project/context/shell-systems-ux-designer/`
...
1. **Detect Missing Context**:
   - Check for existence of `{cwd}/${CLAUDE_CONFIG_DIR}/project/context/shell-systems-ux-designer/`
...
1. **Detect Missing Configuration**:
   ...
   - Check if `{cwd}/${CLAUDE_CONFIG_DIR}/project/context/shell-systems-ux-designer/` does NOT exist
...
```text
Loading project-level CLI UX knowledge from {cwd}/${CLAUDE_CONFIG_DIR}/project/context/shell-systems-ux-designer/
...
if [ -d "${CLAUDE_CONFIG_DIR}/project/context/shell-systems-ux-designer" ]; then
...
- Is `${CLAUDE_CONFIG_DIR}/project/context/shell-systems-ux-designer/` present?
...
- Project knowledge: `{project}/${CLAUDE_CONFIG_DIR}/project/context/shell-systems-ux-designer/`
