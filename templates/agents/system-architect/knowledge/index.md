...
Combine this user-level knowledge with project-level architecture documentation in `{project}/.claude/project/context/system-architect/`:
...
- **Project Architecture**: `{project}/.claude/project/context/system-architect/`
